document.addEventListener('DOMContentLoaded', () => {
    ...
    .then(data => {
        ...
        data.reverse().forEach(entry => {
            ...
            if (entry.username === entry.session_username && entry.like_status === 'like') {
            ...
            if (entry.username === entry.session_username && entry.like_status === 'dislike') {
            ...
            if (entry.logged_in && entry.username === entry.session_username) {
                ...
                template_trashcan.onclick = function() {
                        console.log(trashcanImage.dataset.postId);
